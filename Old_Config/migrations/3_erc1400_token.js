...
//Valorar aquí si hacen falta todas las particiones, quizás con una es suficiente
...
module.exports = async function (deployer, network, accounts) {
  ...
  await deployer.deploy(MyContract, 'ERC1400Token', 'DAU', 1, [controller], partitions);
  console.log('\n   > ERC1400 token deployment: Success -->', MyContract.address);
};
